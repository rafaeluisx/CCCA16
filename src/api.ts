...
app.post("/signup", async function (req, res) {
  ...
  try {
    const [emailAlreadyUsed] = await connection.query(
...
async function addAccount(
  ...
  await connection.query(
    "insert into cccat16.account (account_id, name, email, cpf, car_plate, passcode, is_passenger, is_driver) values ($1, $2, $3, $4, $5, $6, $7, $8)",
    [
      id,
      req.body.name,
      req.body.email,
